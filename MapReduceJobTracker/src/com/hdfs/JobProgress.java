...
public class JobProgress {
	...
	HashMap<Integer, Boolean> isMapIdCompleteStatusRecieved = new HashMap<Integer, Boolean>();

	HashMap<Integer, Boolean> isReduceIdCompleteStatusRecieved = new HashMap<Integer, Boolean>();
